...
def findMCParticles(branches) :
	returnlist = []
	#names = ['t','tbar','lep','nu','lepb','hadW','hadb'] #uncomment this line when running on nTuples created after 5/5/2017 (I fixed the b-quark assignment; it was backward before!) 
	names = ['t','tbar','lep','nu','hadb','hadW','lepb'] #get rid of this line when running on nTuples created after 5/5/2017 
	for name in names :
