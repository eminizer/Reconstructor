...
MT_l2 = 172.6 #leptonic top mass for type 2 tops
MT_h2 = 173.7 #hadronic top mass for type 2 tops
MT_l3 = 171.9 #leptonic top mass for type 3 tops
MT_h3 = 168.1 #hadronic top mass for type 3 tops
WW = 2.0 #W width
WT = 1.4 #top width
WT_l1 = 15.4 #leptonic top width for type 1 tops
WT_h1 = 17.5 #hadronic top width for type 1 tops
WT_l2 = 15.8 #leptonic top width for type 2 tops
WT_h2 = 17.7 #hadronic top width for type 2 tops
WT_l3 = 16.0 #leptonic top width for type 3 tops
WT_h3 = 19.5 #hadronic top width for type 3 tops
lep_gvs=[]
met_gvs=[]
blep_gvs=[]
hadt_gvs=[]
