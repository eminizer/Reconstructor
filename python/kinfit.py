...
MT_l2 = 172.7 #leptonic top mass for type 2 tops
...
WW = 2.0 #W width
WT = 1.4 #top width
WT_l1 = 15.5 #leptonic top width for type 1 tops
...
WT_l3 = 16.1 #leptonic top width for type 3 tops
WT_h3 = 19.7 #hadronic top width for type 3 tops
lep_gvs=[]
met_gvs=[]
blep_gvs=[]
hadt_gvs=[]
