...
if mode in ['trig','trigger','t'] :
	...
	options.skimcut = 'fullselection==1 || eltrig_fullselection==1 || elID_fullselection==1'
elif mode in ['id'] :
	mode = 'id'
	leptype='electrons'
	options.MC_weights = '((19690.184+16226.452)*(lepflavor==1)+(19171.010+16214.862)*(lepflavor==2))*weight*sf_pileup*sf_btag_eff*sf_mu_R*sf_mu_F*sf_scale_comb*sf_pdf_alphas'
...
#control plots
#type-1
all_plots.append(Plot('npv_t1',['ngoodvtx'],'; # primary vertices; Events/bin',101,-0.5,100.5,addl_cuts='eventTopology==1'))
all_plots.append(Plot('vpz_t1',['par_0'],'; p^{#nu}_{Z} [GeV]; Events/20 GeV',40,-400.,400.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('lsf_t1',['par_1'],'; #lambda_{1}; Events/0.001',40,0.97,1.01,addl_cuts='eventTopology==1'))
all_plots.append(Plot('lbsf_t1',['par_2'],'; #lambda_{2}; Events/0.02',30,0.6,1.2,addl_cuts='eventTopology==1'))
all_plots.append(Plot('hbsf1_t1',['par_3','par_4'],'; #lambda_{3/4}; Events/0.02',30,0.6,1.2,addl_cuts='eventTopology==1'))
all_plots.append(Plot('chi2_t1',['chi2'],'; #chi^{2}; Events/5',40,-50.,150.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('leppT_t1',['lep_pt'],';'+lepstring+' p_{T} [GeV]; Events/10 GeV',40,0.,400.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('lepeta_t1',['lep_eta'],';'+lepstring+' #eta; Events/0.1',30,-3.,3.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('leprelpT_t1',['lep_relPt'],'; p_{T}^{rel}('+shortlepstring+', jet) [GeV]; Events/10 GeV',40,0.,400.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('lepdR_t1',['lep_dR'],'; #Delta R('+shortlepstring+', jet); Events/0.1',30,0.,3.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('lepIso_t1',['lep_Iso'],'; '+lepstring+' PF relative isolation; Events/0.05',40,0.,2.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak41pT_t1',['ak41_pt'],'; AK4 jet1 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak41eta_t1',['ak41_eta'],'; AK4 jet1 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==1'))
...
all_plots.append(Plot('ak42eta_t1',['ak42_eta'],'; AK4 jet2 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==1'))
...
all_plots.append(Plot('ak8eta_t1',['ak81_eta'],'; top-tagged AK8 jet #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak8M_t1',['ak81_M'],'; top-tagged AK8 jet mass [GeV]; Events/10 GeV',30,0.0,300.0,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak8tau32_t1',['ak81_tau32'],'; top-tagged AK8 jet #tau_{32}; Events/0.05 GeV',20,0.,1.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak8SDM_t1',['ak81_SDM'],'; top-tagged AK8 jet softdrop mass [GeV]; Events/10 GeV',30,0.,300.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('MET_t1',['met_E'],'; MET [GeV]; Events/20 GeV',30,0.,600.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('METphi_t1',['met_phi'],'; MET #phi; Events/0.2',31,-3.2,3.2,addl_cuts='eventTopology==1'))
all_plots.append(Plot('nak4_t1',['nak4jets'],'; # AK4 jets; Events/bin',16,-0.5,15.5,addl_cuts='eventTopology==1'))
all_plots.append(Plot('nak8_t1',['nak8jets'],'; # AK8 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==1'))
all_plots.append(Plot('nttags_t1',['ntTags'],'; # top-tagged AK8 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==1'))
all_plots.append(Plot('nbtags_t1',['nbTags'],'; # b-tagged AK4 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==1',iPos=33,lPos=2))
all_plots.append(Plot('lepWpT_t1',['scaled_lepW_pt'],'; reconstructed W_{lep} p_{T} [GeV]; Events/5 GeV',30,0.,1200.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('lepWM_t1',['scaled_lepW_M'],'; reconstructed W_{lep} mass [GeV]; Events/5 GeV',40,0.,200.,addl_cuts='eventTopology==1'))
...
all_plots.append(Plot('cstar_t1',['cstar'],'; c*; Events/0.1',20,-1.,1.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('x_F_t1',['abs(x_F)'],'; |x_{F}|; Events/0.05',20,0.,1.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('M_t1',['M'],'; M; Events/50 GeV',30,0.,1500.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ttpt_t1',['tt_pt'],'; top pair p_{T} [GeV]; Events/20 GeV',30,0.,600.,addl_cuts='eventTopology==1'))
...
all_plots.append(Plot('lep_v_dPhi_t1',['lep_v_deltaPhi'],'; #Delta #phi ('+shortlepstring+', #nu); Events/0.1',30,0.,3.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('lept_hadt_dR_t1',['lept_hadt_deltaR'],'; #Delta R (t_{lep}, t_{had}); Events/0.1',30,0.,6.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak43pT_t1',['ak43_pt'],'; AK4 jet3 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak43eta_t1',['ak43_eta'],'; AK4 jet3 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak43csv_t1',['ak43_csvv2'],'; AK4 jet3 CSVv2; Events/0.025',40,0.0,1.0,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak44pT_t1',['ak44_pt'],'; AK4 jet4 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==1'))
all_plots.append(Plot('ak44eta_t1',['ak44_eta'],'; AK4 jet4 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==1'))
...
#type-2
all_plots.append(Plot('npv_t2',['ngoodvtx'],'; # primary vertices; Events/bin',101,-0.5,100.5,addl_cuts='eventTopology==2'))
all_plots.append(Plot('vpz_t2',['par_0'],'; p^{#nu}_{Z} [GeV]; Events/20 GeV',40,-400.,400.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('lsf_t2',['par_1'],'; #lambda_{1}; Events/0.001',40,0.97,1.01,addl_cuts='eventTopology==2'))
all_plots.append(Plot('lbsf_t2',['par_2'],'; #lambda_{2}; Events/0.02',30,0.6,1.2,addl_cuts='eventTopology==2'))
all_plots.append(Plot('hbsf1_t2',['par_3','par_4','par_5'],'; #lambda_{3/4/5}; Events/0.02',30,0.6,1.2,addl_cuts='eventTopology==2'))
all_plots.append(Plot('chi2_t2',['chi2'],'; #chi^{2}; Events/5',40,-50.,150.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('leppT_t2',['lep_pt'],';'+lepstring+' p_{T} [GeV]; Events/10 GeV',40,0.,400.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('lepeta_t2',['lep_eta'],';'+lepstring+' #eta; Events/0.1',30,-3.,3.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('leprelpT_t2',['lep_relPt'],'; p_{T}^{rel}('+shortlepstring+', jet) [GeV]; Events/10 GeV',40,0.,400.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('lepdR_t2',['lep_dR'],'; #Delta R('+shortlepstring+', jet); Events/0.1',30,0.,3.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('lepIso_t2',['lep_Iso'],'; '+lepstring+' PF relative isolation; Events/0.05',40,0.,2.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak41pT_t2',['ak41_pt'],'; AK4 jet1 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak41eta_t2',['ak41_eta'],'; AK4 jet1 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==2'))
...
all_plots.append(Plot('ak42eta_t2',['ak42_eta'],'; AK4 jet2 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==2'))
...
all_plots.append(Plot('ak8eta_t2',['ak81_eta'],'; AK8 jet1 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak8M_t2',['ak81_M'],'; AK8 jet1 mass [GeV]; Events/10 GeV',30,0.0,300.0,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak8tau32_t2',['ak81_tau32'],'; AK8 jet1 #tau_{32}; Events/0.05 GeV',20,0.,1.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak8SDM_t2',['ak81_SDM'],'; AK8 jet1 softdrop mass [GeV]; Events/10 GeV',30,0.,300.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('MET_t2',['met_E'],'; MET [GeV]; Events/20 GeV',30,0.,600.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('METphi_t2',['met_phi'],'; MET #phi; Events/0.2',31,-3.2,3.2,addl_cuts='eventTopology==2'))
all_plots.append(Plot('nak4_t2',['nak4jets'],'; # AK4 jets; Events/bin',16,-0.5,15.5,addl_cuts='eventTopology==2'))
all_plots.append(Plot('nak8_t2',['nak8jets'],'; # AK8 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==2'))
all_plots.append(Plot('nttags_t2',['ntTags'],'; # top-tagged AK8 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==2'))
all_plots.append(Plot('nbtags_t2',['nbTags'],'; # b-tagged AK4 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==2',iPos=33,lPos=2))
all_plots.append(Plot('lepWpT_t2',['scaled_lepW_pt'],'; reconstructed W_{lep} p_{T} [GeV]; Events/5 GeV',30,0.,1200.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('lepWM_t2',['scaled_lepW_M'],'; reconstructed W_{lep} mass [GeV]; Events/5 GeV',40,0.,200.,addl_cuts='eventTopology==2'))
...
all_plots.append(Plot('cstar_t2',['cstar'],'; c*; Events/0.1',20,-1.,1.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('x_F_t2',['abs(x_F)'],'; |x_{F}|; Events/0.05',20,0.,1.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('M_t2',['M'],'; M; Events/50 GeV',30,0.,1500.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ttpt_t2',['tt_pt'],'; top pair p_{T} [GeV]; Events/20 GeV',30,0.,600.,addl_cuts='eventTopology==2'))
...
all_plots.append(Plot('lep_v_dPhi_t2',['lep_v_deltaPhi'],'; #Delta #phi ('+shortlepstring+', #nu); Events/0.1',30,0.,3.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('lept_hadt_dR_t2',['lept_hadt_deltaR'],'; #Delta R (t_{lep}, t_{had}); Events/0.1',30,0.,6.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak43pT_t2',['ak43_pt'],'; AK4 jet3 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak43eta_t2',['ak43_eta'],'; AK4 jet3 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak43csv_t2',['ak43_csvv2'],'; AK4 jet3 CSVv2; Events/0.025',40,0.0,1.0,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak44pT_t2',['ak44_pt'],'; AK4 jet4 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==2'))
all_plots.append(Plot('ak44eta_t2',['ak44_eta'],'; AK4 jet4 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==2'))
...
#type-3
all_plots.append(Plot('npv_t3',['ngoodvtx'],'; # primary vertices; Events/bin',101,-0.5,100.5,addl_cuts='eventTopology==3'))
all_plots.append(Plot('vpz_t3',['par_0'],'; p^{#nu}_{Z} [GeV]; Events/20 GeV',40,-400.,400.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('lsf_t3',['par_1'],'; #lambda_{1}; Events/0.001',40,0.97,1.01,addl_cuts='eventTopology==3'))
all_plots.append(Plot('lbsf_t3',['par_2'],'; #lambda_{2}; Events/0.02',30,0.6,1.2,addl_cuts='eventTopology==3'))
all_plots.append(Plot('hbsf1_t3',['par_3','par_4','par_5'],'; #lambda_{3/4/5}; Events/0.02',30,0.6,1.2,addl_cuts='eventTopology==3'))
all_plots.append(Plot('chi2_t3',['chi2'],'; #chi^{2}; Events/5',40,-50.,150.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('leppT_t3',['lep_pt'],';'+lepstring+' p_{T} [GeV]; Events/10 GeV',40,0.,400.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('lepeta_t3',['lep_eta'],';'+lepstring+' #eta; Events/0.1',30,-3.,3.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('leprelpT_t3',['lep_relPt'],'; p_{T}^{rel}('+shortlepstring+', jet) [GeV]; Events/10 GeV',40,0.,400.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('lepdR_t3',['lep_dR'],'; #Delta R('+shortlepstring+', jet); Events/0.1',30,0.,3.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('lepIso_t3',['lep_Iso'],'; '+lepstring+' PF relative isolation; Events/0.05',40,0.,2.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak41pT_t3',['ak41_pt'],'; AK4 jet1 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak41eta_t3',['ak41_eta'],'; AK4 jet1 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==3'))
...
all_plots.append(Plot('ak42eta_t3',['ak42_eta'],'; AK4 jet2 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==3'))
...
all_plots.append(Plot('ak8eta_t3',['ak81_eta'],'; AK8 jet1 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak8M_t3',['ak81_M'],'; AK8 jet1 mass [GeV]; Events/10 GeV',30,0.0,300.0,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak8tau32_t3',['ak81_tau32'],'; AK8 jet1 #tau_{32}; Events/0.05 GeV',20,0.,1.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak8SDM_t3',['ak81_SDM'],'; AK8 jet1 softdrop mass [GeV]; Events/10 GeV',30,0.,300.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('MET_t3',['met_E'],'; MET [GeV]; Events/20 GeV',30,0.,600.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('METphi_t3',['met_phi'],'; MET #phi; Events/0.2',31,-3.2,3.2,addl_cuts='eventTopology==3'))
all_plots.append(Plot('nak4_t3',['nak4jets'],'; # AK4 jets; Events/bin',16,-0.5,15.5,addl_cuts='eventTopology==3'))
all_plots.append(Plot('nak8_t3',['nak8jets'],'; # AK8 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==3'))
all_plots.append(Plot('nttags_t3',['ntTags'],'; # top-tagged AK8 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==3'))
all_plots.append(Plot('nbtags_t3',['nbTags'],'; # b-tagged AK4 jets; Events/bin',11,-0.5,10.5,addl_cuts='eventTopology==3',iPos=33,lPos=2))
all_plots.append(Plot('lepWpT_t3',['scaled_lepW_pt'],'; reconstructed W_{lep} p_{T} [GeV]; Events/5 GeV',30,0.,1200.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('lepWM_t3',['scaled_lepW_M'],'; reconstructed W_{lep} mass [GeV]; Events/5 GeV',40,0.,200.,addl_cuts='eventTopology==3'))
...
all_plots.append(Plot('cstar_t3',['cstar'],'; c*; Events/0.1',20,-1.,1.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('x_F_t3',['abs(x_F)'],'; |x_{F}|; Events/0.05',20,0.,1.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('M_t3',['M'],'; M; Events/50 GeV',30,0.,1500.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ttpt_t3',['tt_pt'],'; top pair p_{T} [GeV]; Events/20 GeV',30,0.,600.,addl_cuts='eventTopology==3'))
...
all_plots.append(Plot('lep_v_dPhi_t3',['lep_v_deltaPhi'],'; #Delta #phi ('+shortlepstring+', #nu); Events/0.1',30,0.,3.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('lept_hadt_dR_t3',['lept_hadt_deltaR'],'; #Delta R (t_{lep}, t_{had}); Events/0.1',30,0.,6.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak43pT_t3',['ak43_pt'],'; AK4 jet3 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak43eta_t3',['ak43_eta'],'; AK4 jet3 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak43csv_t3',['ak43_csvv2'],'; AK4 jet3 CSVv2; Events/0.025',40,0.0,1.0,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak44pT_t3',['ak44_pt'],'; AK4 jet4 p_{T} [GeV]; Events/20 GeV',40,0.,800.,addl_cuts='eventTopology==3'))
all_plots.append(Plot('ak44eta_t3',['ak44_eta'],'; AK4 jet4 #eta; Events/0.1',30,-3.0,3.0,addl_cuts='eventTopology==3'))
