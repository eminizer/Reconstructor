...
if mode=='' or mode=='wjetscr' or mode.startswith('qcd') :
	...
	all_plots.append(Plot('lep_v_dPhi_t1',['lep_v_deltaPhi'],'; #Delta #phi ('+shortlepstring+', #nu); Events/0.1',32,-3.2,3.2,addl_cuts='eventTopology==1',iPos=33,lPos=2))
	...
	all_plots.append(Plot('lep_v_dPhi_t2',['lep_v_deltaPhi'],'; #Delta #phi ('+shortlepstring+', #nu); Events/0.1',32,-3.2,3.2,addl_cuts='eventTopology==2',iPos=33,lPos=2))
	...
	if not mode=='wjetscr' :
		...
		all_plots.append(Plot('lep_v_dPhi_t3',['lep_v_deltaPhi'],'; #Delta #phi ('+shortlepstring+', #nu); Events/0.1',32,-3.2,3.2,addl_cuts='eventTopology==3',iPos=33,lPos=2))
